...
public class RedisUtil {
    ...
    /**
     * 在指定的 key 不存在时，为 key 设置指定的值,并设置时间.
     *
     * @param key   键
     * @param value 值
     * @param time  时间
     * @return true成功 false 失败
     */
    public boolean setnx(final String key, Object value, long time, TimeUnit timeUnit) {
        try {
     ...
     * @return true成功 false 失败
     */
    public boolean setnx(final String key, Object value, Duration duration) {
        try {
    ...
    public Long hincrBy(String key, Object hashKey, long value, long expireTime) {
        HashOperations<String, Object, Object> hash = redisTemplate.opsForHash();
        long num = hash.increment(key, hashKey, value);
        redisTemplate.expire(key, expireTime, TimeUnit.SECONDS);
        return num;
    }
